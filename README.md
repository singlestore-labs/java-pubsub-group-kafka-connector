...
| cps.pollTimeoutMs                      | Long                                                               | 0                            | The maximum number of milliseconds to wait for messages. A value of `0` waits indefinitely until a message arrives or the subscriber fails.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
